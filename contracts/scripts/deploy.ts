...
async function main() {
  ...
  // Deploy EcoPoints
  console.log("⭐ Deploying EcoPoints...");
  ...
  const ecoPointsAddress = await ecoPoints.getAddress();
  console.log("✅ EcoPoints deployed to:", ecoPointsAddress);
  ...
  console.log("🔐 Granting MINTER_ROLE for EcoPoints...");
  const ECO_POINTS_MINTER_ROLE = await ecoPoints.MINTER_ROLE();
  await ecoPoints.grantRole(ECO_POINTS_MINTER_ROLE, projectRegistryAddress);
  await ecoPoints.grantRole(ECO_POINTS_MINTER_ROLE, challengeRegistryAddress);
  console.log("✅ MINTER_ROLE granted to ProjectRegistry and ChallengeRegistry");
  ...
  console.log("EcoPoints:", ecoPointsAddress);
  console.log("ProjectRegistry:", projectRegistryAddress);
  console.log("ChallengeRegistry:", challengeRegistryAddress);
  console.log("==================================================");
  ...
  const addresses = {
    ...
    EcoPoints: ecoPointsAddress,
    ProjectRegistry: projectRegistryAddress,
    ChallengeRegistry: challengeRegistryAddress,
    network: "amoy"
  };
